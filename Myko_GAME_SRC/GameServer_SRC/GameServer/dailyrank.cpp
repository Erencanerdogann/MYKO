...
void CUser::HandleDailyRankShow(Packet& pkt)
{
	...
	case DailyRankType::GRAND_MERCHANT:
	{
		...
		wpos = newpkt.wpos();
		Send(&newpkt);
		m_dailyrankrefresh[(int)DailyRankType::GRAND_MERCHANT] = true;
	}
	break;
	case DailyRankType::MONSTER_HUNDER:
	{
		...
		wpos = newpkt.wpos();
		Send(&newpkt);
		m_dailyrankrefresh[(int)DailyRankType::MONSTER_HUNDER] = true;
	}
	break;
	case DailyRankType::SHOZIN:
	{
		...
		wpos = newpkt.wpos();
		Send(&newpkt);
		m_dailyrankrefresh[(int)DailyRankType::SHOZIN] = true;
	}
	break;
	case DailyRankType::KNIGHT_ADONIS:
	{
		...
		wpos = newpkt.wpos();
		Send(&newpkt);
		m_dailyrankrefresh[(int)DailyRankType::KNIGHT_ADONIS] = true;
	}
	break;
	case DailyRankType::HERO_OF_CHAOS:
	{
		...
		wpos = newpkt.wpos();
		Send(&newpkt);
		m_dailyrankrefresh[(int)DailyRankType::HERO_OF_CHAOS] = true;
	}
	break;
	case DailyRankType::DISCIPLE_KERON:
	{
		...
		wpos = newpkt.wpos();
		Send(&newpkt);
		m_dailyrankrefresh[(int)DailyRankType::DISCIPLE_KERON] = true;
	}
	break;
