...
public:
	...
	std::shared_mutex			m_lockUserArray;
	std::shared_mutex			m_lockNpcArray;  // S4: shared_mutex for read-heavy access
	std::shared_mutex			m_lockBotArray;  // S4: shared_mutex for read-heavy access
