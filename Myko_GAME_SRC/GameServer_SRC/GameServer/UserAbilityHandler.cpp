...
void CUser::SetUserAbility(bool bSendPacket)
{
	...
	/*21.01.2024*/
	uint32 MaxWeightAmountNew = 0;
	if (m_bMaxWeightAmount > 100)
	{
		MaxWeightAmountNew = m_bMaxWeightAmount % 100;
		if (MaxWeightAmountNew > 0)
			m_sMaxWeight = m_sMaxWeight + ((m_sMaxWeight * MaxWeightAmountNew) / 100);
	}
	/*21.01.2024*/
