...
#define LUA_CLASS CUser
	...
	(
		...
		MAKE_LUA_METHOD(SendNationChangeClan)
...
LUA_WRAPPER_USER_FUNCTION(CashGain);
...
LUA_WRAPPER_USER_FUNCTION(SendNationChangeClan);
...
_LUA_WRAPPER_USER_FUNCTION(GiveCash, CashGain);
