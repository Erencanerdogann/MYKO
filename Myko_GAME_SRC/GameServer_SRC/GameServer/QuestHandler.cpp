...
{
	// FIX H23: Extend lock scope to cover all iterator usage (iterator invalidation after unlock)
	std::lock_guard<std::recursive_mutex> lock(g_pMain->m_questNpcLock);
