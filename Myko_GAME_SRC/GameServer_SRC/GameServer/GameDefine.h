...
struct _BDW_ROOM_INFO
{
	...
	KarusUserList m_KarusUserList;
	ElmoradUserList m_ElmoradUserList;
	uint32 m_iKarusKillCount, m_iElmoradKillCount, m_iKarusMonuCount, m_iElmoMonuCount, m_ElmoScoreBoard, m_KarusScoreBoard, m_AltarElmoScoreBoard, m_AltarKarusScoreBoard; //25.11.2023 m_AltarElmoScoreBoard, m_AltarKarusScoreBoard
	...
	void Initialize(bool reset = false) {
		...
		m_AltarElmoScoreBoard = 0;
		m_AltarKarusScoreBoard = 0;
