...
{
	LOAD_TABLE(CNpcItemSet, g_DBAgent.GetGameDB(), &m_NpcItemArray, false, false);
}
bool CGameServerDlg::LoadZoneKillReward()
{
	LOAD_TABLE(CZoneKillReward, g_DBAgent.GetGameDB(), &m_ZoneKillReward, false, false);
}

bool CGameServerDlg::LoadAntiAfkListTable() {
	Guard lock(m_AntiAfkListLock);
	m_AntiAfkList.clear();
	LOAD_TABLE(CAntifAfkListSet, g_DBAgent.GetGameDB(), nullptr, true, false);
}

bool CGameServerDlg::LoadEventTimerShowTable() {
	LOAD_TABLE(CEventTimerShowSet, g_DBAgent.GetGameDB(), &m_EventTimerShowArray, true, false);
}

bool CGameServerDlg::LoadDamageSettingTable() {
	LOAD_TABLE(CDamageSettingSet, g_DBAgent.GetGameDB(), &pDamageSetting, true, false);
}

bool CGameServerDlg::LoadMonsterItemTable()
{
	LOAD_TABLE(CMonsterItemSet, g_DBAgent.GetGameDB(), &m_MonsterItemArray, false, false);
}

bool CGameServerDlg::LoadCharacterSetValidTable() {
	LOAD_TABLE(CCharacterSetValid, g_DBAgent.GetGameDB(), &m_CharacterSetValidArray, true, false);
}

bool CGameServerDlg::BurningFeatureTable()
{
	LOAD_TABLE(CBurningFeatureSet, g_DBAgent.GetGameDB(), nullptr, false, false);
}

bool CGameServerDlg::LoadMakeItemGroupTable()
{
	LOAD_TABLE(CMakeItemGroupSet, g_DBAgent.GetGameDB(), &m_MakeItemGroupArray, false, false);
}

bool CGameServerDlg::LoadMakeItemGroupRandomTable()
{
	LOAD_TABLE(CMakeItemGroupRandomSet, g_DBAgent.GetGameDB(), &m_MakeItemGroupRandomArray, false, false);
}

bool CGameServerDlg::LoadMakeWeaponItemTableData()
{
	LOAD_TABLE(CMakeWeaponTableSet, g_DBAgent.GetGameDB(), &m_MakeWeaponItemArray, true, false);
}
bool CGameServerDlg::LoadItemRightClickExchangeTable()
{
	LOAD_TABLE(CItemRightClickExchange, g_DBAgent.GetGameDB(), &m_LoadRightClickExchange, true, false);
}

bool CGameServerDlg::LoadMakeDefensiveItemTableData()
{
	LOAD_TABLE(CMakeDefensiveTableSet, g_DBAgent.GetGameDB(), &m_MakeDefensiveItemArray, true, false);
}

bool CGameServerDlg::LoadMakeGradeItemTableData()
{
	LOAD_TABLE(CMakeGradeItemTableSet, g_DBAgent.GetGameDB(), &m_MakeGradeItemArray, false, false);
}

bool CGameServerDlg::LoadMakeLareItemTableData()
{
	LOAD_TABLE(CMakeLareItemTableSet, g_DBAgent.GetGameDB(), &m_MakeLareItemArray, false, false);
}

bool CGameServerDlg::LoadNpcTableData(bool bNpcData /*= true*/)
{
	if (bNpcData) { LOAD_TABLE(CNpcTableSet, g_DBAgent.GetGameDB(), &m_arNpcTable, false, false); }
	else { LOAD_TABLE(CMonTableSet, g_DBAgent.GetGameDB(), &m_arMonTable, false, false); }
}

bool CGameServerDlg::LoadNpcPosTable()
{
	LOAD_TABLE(CNpcPosSet, g_DBAgent.GetGameDB(), nullptr, false, false);
}
...
{
	LOAD_TABLE(CItemTableSet, g_DBAgent.GetGameDB(), &m_ItemtableArray, false, false);
}
bool CGameServerDlg::LoadWheelDataSetTable()
{
	LOAD_TABLE(CWheelData, g_DBAgent.GetGameDB(), &m_ItemWheelArray, true, false);
}
bool CGameServerDlg::ReLoadItemTable()
{
	LOAD_TABLE(CReloadItemTableSet, g_DBAgent.GetGameDB(), &m_ItemtableArray, false, true);
}

bool CGameServerDlg::LoadItemSellTable()
{
	LOAD_TABLE(CItemSellTableSet, g_DBAgent.GetGameDB(), &m_ItemSellTableArray, false, false);


}bool CGameServerDlg::LoadZoneOnlineRewardTable()
{
	LOAD_TABLE(CZoneOnlineRewardSet, g_DBAgent.GetGameDB(), &m_ZoneOnlineRewardArray, false, false);
}

bool CGameServerDlg::LoadItemPremiumGiftTable()
{
	LOAD_TABLE(CItemPremiumGift, g_DBAgent.GetGameDB(), &m_ItemPremiumGiftArray, false, false);
}

bool CGameServerDlg::LoadSetItemTable()
{
	LOAD_TABLE(CSetItemTableSet, g_DBAgent.GetGameDB(), &m_SetItemArray, true, false);
}

bool CGameServerDlg::LoadItemExchangeTable()
{
	LOAD_TABLE(CItemExchangeSet, g_DBAgent.GetGameDB(), &m_ItemExchangeArray, true, false);
}

bool CGameServerDlg::LoadItemExchangeExpTable()
{
	LOAD_TABLE(CItemExchangeExpSet, g_DBAgent.GetGameDB(), &m_ItemExchangeExpArray, true, false);
}

bool CGameServerDlg::LoadItemSpecialExchangeTable()
{
	LOAD_TABLE(CItemSpecialExchangeSet, g_DBAgent.GetGameDB(), &m_ItemSpecialExchangeArray, true, false);
}

bool CGameServerDlg::LoadItemExchangeCrashTable()
{
	LOAD_TABLE(CItemExchangeCreashSet, g_DBAgent.GetGameDB(), &m_ItemExchangeCrashArray, true, false);
}

bool CGameServerDlg::LoadItemUpgradeTable()
{
	LOAD_TABLE(CItemUpgradeSet, g_DBAgent.GetGameDB(), &m_ItemUpgradeArray, false, false);
}

bool CGameServerDlg::LoadItemOpTable()
{
	LOAD_TABLE(CItemOpSet, g_DBAgent.GetGameDB(), &m_ItemOpArray, true, false);
}

bool CGameServerDlg::LoadServerResourceTable()
{
	LOAD_TABLE(CServerResourceSet, g_DBAgent.GetGameDB(), &m_ServerResourceArray, false, false);
}
...
bool CGameServerDlg::LoadQuestHelperTable()
{
	...
	LOAD_TABLE(CQuestHelperSet, g_DBAgent.GetGameDB(), &m_QuestHelperArray, true, false);
}

bool CGameServerDlg::LoadQuestMonsterTable()
{
	LOAD_TABLE(CQuestMonsterSet, g_DBAgent.GetGameDB(), &m_QuestMonsterArray, true, false);
}

bool CGameServerDlg::LoadMagicTable()
{
	LOAD_TABLE(CMagicTableSet, g_DBAgent.GetGameDB(), &m_MagictableArray, false, false);
}

bool CGameServerDlg::LoadMagicType1()
{
	LOAD_TABLE(CMagicType1Set, g_DBAgent.GetGameDB(), &m_Magictype1Array, false, false);
}

bool CGameServerDlg::LoadMagicType2()
{
	LOAD_TABLE(CMagicType2Set, g_DBAgent.GetGameDB(), &m_Magictype2Array, false, false);
}

bool CGameServerDlg::LoadMagicType3()
{
	LOAD_TABLE(CMagicType3Set, g_DBAgent.GetGameDB(), &m_Magictype3Array, false, false);
}

bool CGameServerDlg::LoadMagicType4()
{
	LOAD_TABLE(CMagicType4Set, g_DBAgent.GetGameDB(), &m_Magictype4Array, false, false);
}

bool CGameServerDlg::LoadMagicType5()
{
	LOAD_TABLE(CMagicType5Set, g_DBAgent.GetGameDB(), &m_Magictype5Array, false, false);
}

bool CGameServerDlg::LoadMagicType6()
{
	LOAD_TABLE(CMagicType6Set, g_DBAgent.GetGameDB(), &m_Magictype6Array, false, false);
}

bool CGameServerDlg::LoadMagicType7()
{
	LOAD_TABLE(CMagicType7Set, g_DBAgent.GetGameDB(), &m_Magictype7Array, false, false);
}

bool CGameServerDlg::LoadMagicType8()
{
	LOAD_TABLE(CMagicType8Set, g_DBAgent.GetGameDB(), &m_Magictype8Array, false, false);
}

bool CGameServerDlg::LoadMagicType9()
{
	LOAD_TABLE(CMagicType9Set, g_DBAgent.GetGameDB(), &m_Magictype9Array, false, false);
}

bool CGameServerDlg::LoadRentalList()
{
	LOAD_TABLE(CRentalItemSet, g_DBAgent.GetGameDB(), &m_RentalItemArray, true, false);
}

bool CGameServerDlg::LoadCoefficientTable()
{
	LOAD_TABLE(CCoefficientSet, g_DBAgent.GetGameDB(), &m_CoefficientArray, false, false);
}

bool CGameServerDlg::LoadLevelUpTable()
{
	LOAD_TABLE(CLevelUpTableSet, g_DBAgent.GetGameDB(), &m_LevelUpArray, false, false);
}
...
bool CGameServerDlg::XCodeLoadEventTables() {
	...
	LOAD_TABLE_ERROR_ONLY(CEventTimeDaySet, g_DBAgent.GetGameDB(), &pEventTimeOpt, true, false);
	LOAD_TABLE_ERROR_ONLY(CEventTimeOptSet, g_DBAgent.GetGameDB(), &pEventTimeOpt, true, false);
	return true;
}

bool CGameServerDlg::XCodeLoadEventVroomTables() {
	LOAD_TABLE(CEventVroomListSet, g_DBAgent.GetGameDB(), &pEventTimeOpt, true, false);
}

bool CGameServerDlg::LoadKnightsAllianceTable(bool bIsSlient)
{
	LOAD_TABLE(CKnightsAllianceSet, g_DBAgent.GetGameDB(), &m_KnightsAllianceArray, true, bIsSlient);
}

bool CGameServerDlg::LoadMiningExchangeListTable()
{
	LOAD_TABLE(CMiningExchange, g_DBAgent.GetGameDB(), &m_MiningExchangeArray, true, false);
}
...
bool CGameServerDlg::LoadEventRewardTable()
{
	...
	LOAD_TABLE_ERROR_ONLY(CEventRewardSet, g_DBAgent.GetGameDB(), &m_EventRewardArray, true, false);
	LOAD_TABLE_ERROR_ONLY(CEventChaosGift, g_DBAgent.GetGameDB(), nullptr, true, false);
	return true;
}

bool CGameServerDlg::LoadBeefEventPlayTimerTable()
{
	LOAD_TABLE(CEventBeefSchedulePlayTimer, g_DBAgent.GetGameDB(), &m_BeefEventPlayTimerArray, true, false);
}

bool CGameServerDlg::LoadFtEventPlayTimerTable() 
{
	LOAD_TABLE(CFtEventTimeSet, g_DBAgent.GetGameDB(), &pForgettenTemple.ptimeopt, true, false);
}

bool CGameServerDlg::LoadAutomaticCommand()
{
	LOAD_TABLE(CAutomaticCommandSet, g_DBAgent.GetGameDB(), &g_pMain->m_AutomaticCommandArray, true, false);
}

bool CGameServerDlg::LoadAchieveTitleTable()
{
	LOAD_TABLE(CAchieveTitleSet, g_DBAgent.GetGameDB(), &m_AchieveTitleArray, true, false);
}

bool CGameServerDlg::LoadAchieveWarTable()
{
	LOAD_TABLE(CAchieveWarSet, g_DBAgent.GetGameDB(), &m_AchieveWarArray, true, false);
}

bool CGameServerDlg::LoadAchieveMainTable()
{
	LOAD_TABLE(CAchieveMainSet, g_DBAgent.GetGameDB(), &m_AchieveMainArray, true, false);
}

bool CGameServerDlg::LoadAchieveMonsterTable()
{
	LOAD_TABLE(CAchieveMonsterSet, g_DBAgent.GetGameDB(), &m_AchieveMonsterArray, true, false);
}

bool CGameServerDlg::LoadAchieveNormalTable()
{
	LOAD_TABLE(CAchieveNormalSet, g_DBAgent.GetGameDB(), &m_AchieveNormalArray, true, false);
}

bool CGameServerDlg::LoadRandomBossTable()
{
	LOAD_TABLE(CRandomBossSet, g_DBAgent.GetGameDB(), &m_MonsterBossRandom, true, false);
}

bool CGameServerDlg::LoadRandomBoosStageTable()
{
	LOAD_TABLE(CRandomBossStageSet, g_DBAgent.GetGameDB(), &m_MonsterBossStage, true, false);
}

bool CGameServerDlg::LoadAchieveComTable()
{
	LOAD_TABLE(CAchieveComSet, g_DBAgent.GetGameDB(), &m_AchieveComArray, true, false);
}

bool CGameServerDlg::LoadDungeonDefenceMonsterTable()
{
	LOAD_TABLE(CDungeonDefenceMonsterListSet, g_DBAgent.GetGameDB(), &m_DungeonDefenceMonsterListArray, true, false);
}

bool CGameServerDlg::LoadDungeonDefenceStageTable()
{
	LOAD_TABLE(CDungeonDefenceStageListSet, g_DBAgent.GetGameDB(), &m_DungeonDefenceStageListArray, true, false);
}

bool CGameServerDlg::LoadKnightReturnLetterGiftItemTable()
{
	LOAD_TABLE(CUserReturnLetterGiftItem, g_DBAgent.GetGameDB(), &m_KnightReturnLetterGiftListArray, true, false);
}

bool CGameServerDlg::LoadKnightsSiegeWarsTable(bool bIsSlient)
{
	LOAD_TABLE(CKnightsSiegeWarfare, g_DBAgent.GetGameDB(), &pSiegeWar, true, false);
}

bool CGameServerDlg::LoadCollectionRaceEventTable()
{
	LOAD_TABLE(CollectionRaceEventListSet, g_DBAgent.GetGameDB(), &m_CollectionRaceListArray, true, false);
}

bool CGameServerDlg::LoadRimaLotteryEventTable()
{
	LOAD_TABLE(CRimaLottery, g_DBAgent.GetGameDB(), &m_RimaLotteryArray, true, false);
}

bool CGameServerDlg::LoadDailyQuestListTable() {
	LOAD_TABLE_ERROR_ONLY(CDailyQyestSet, g_DBAgent.GetGameDB(), &m_DailyQuestArray, true, false);
	return true;
}
...
{
	LOAD_TABLE(CPetStatsInfoSet, g_DBAgent.GetGameDB(), &m_PetInfoSystemArray, true, false);
}

bool CGameServerDlg::LoadPetImageChangeTable()
{
	LOAD_TABLE(CPetImageChane, g_DBAgent.GetGameDB(), &m_PetTransformSystemArray, true, false);
}

bool CGameServerDlg::LoadZindanWarStageListTable() {
	LOAD_TABLE(CZindanWarStagesList, g_DBAgent.GetGameDB(), &m_ZindanWarStageListArray, true, false);
}

bool CGameServerDlg::LoadZindanWarSummonListTable() {
	LOAD_TABLE(CZindanWarMonsList, g_DBAgent.GetGameDB(), &m_ZindanWarSummonListArray, true, false);
}

bool CGameServerDlg::LoadUserRankings()
{
	g_DBAgent.UpdateRanks();
	CUserPersonalRankSet UserPersonalRankSet(g_DBAgent.GetGameDB(), &m_UserKarusPersonalRankMap, &m_UserElmoPersonalRankMap);
	CUserKnightsRankSet  UserKnightsRankSet(g_DBAgent.GetGameDB(), &m_UserKarusKnightsRankMap, &m_UserElmoKnightsRankMap);
...
{
	LOAD_TABLE(CCharacterSealSet, g_DBAgent.GetGameDB(), &m_CharacterSealItemArray, true, false);
}
...
{
	LOAD_TABLE(CKnightsCapeSet, g_DBAgent.GetGameDB(), &m_KnightsCapeArray, false, false);
}
...
bool CGameServerDlg::LoadKnightsRankTable(bool bWarTime /*= false*/, bool bIsSlient /*= false*/)
{
	...
	LOAD_TABLE_ERROR_ONLY(CKnightsRankSet, g_DBAgent.GetGameDB(), nullptr, true, bIsSlient);
...
{
	LOAD_TABLE(CStartPositionSet, g_DBAgent.GetGameDB(), &m_StartPositionArray, false, false);
}

bool CGameServerDlg::LoadBattleTable()
{
	LOAD_TABLE(CBattleSet, g_DBAgent.GetGameDB(), &m_byOldVictory, true, false);
}

bool CGameServerDlg::LoadCapeCastellanBonus()
{
	LOAD_TABLE(xCapeCastellanBonus, g_DBAgent.GetGameDB(), &m_CapeCastellanBonus, true, false);
}
...
{
	LOAD_TABLE(CSheriffReportList, g_DBAgent.GetGameDB(), &m_SheriffArray, true, false);
}

bool CGameServerDlg::LoadMonsterResourceTable()
{
	LOAD_TABLE(CMonsterResourceSet, g_DBAgent.GetGameDB(), &m_MonsterResourceArray, false, false);
}

bool CGameServerDlg::LoadForgettenTempleSummonListTable() {
	LOAD_TABLE(CForgettenTMonsList, g_DBAgent.GetGameDB(), &m_ForgettenTempleMonsterArray, true, false);
}

bool CGameServerDlg::LoadForgettenTempleStagesListTable() {
	LOAD_TABLE(CForgettenStagesList, g_DBAgent.GetGameDB(), &m_ForgettenTempleStagesArray, true, false);
}

bool CGameServerDlg::LoadMonsterChallengeTable()
{
	LOAD_TABLE(CMonsterChallenge, g_DBAgent.GetGameDB(), &m_MonsterChallengeArray, true, false);
}

bool CGameServerDlg::LoadMonsterChallengeSummonListTable()
{
	LOAD_TABLE(CMonsterChallengeSummonList, g_DBAgent.GetGameDB(), &m_MonsterChallengeSummonListArray, true, false);
}

bool CGameServerDlg::LoadMonsterSummonListTable()
{
	LOAD_TABLE(CMonsterSummonListSet, g_DBAgent.GetGameDB(), &m_MonsterSummonList, true, false);
}

bool CGameServerDlg::LoadChaosStoneMonsterListTable()
{
	LOAD_TABLE(CChaosStoneSummonListSet, g_DBAgent.GetGameDB(), &m_ChaosStoneSummonListArray, true, false);
}

bool CGameServerDlg::LoadChaosStoneCoordinateTable()
{
	LOAD_TABLE(CChaosStoneCoordinate, g_DBAgent.GetGameDB(), &m_ChaosStoneRespawnCoordinateArray, true, false);
}

bool CGameServerDlg::LoadMonsterRespawnLoopListTable() {
	LOAD_TABLE(CMonsterRespawnStableListSet, g_DBAgent.GetGameDB(), &m_MonsterRespawnLoopArray, true, false);
}

bool CGameServerDlg::LoadMonsterUnderTheCastleTable()
{
	LOAD_TABLE(CMonsterUnderTheCastleSet, g_DBAgent.GetGameDB(), &m_MonsterUnderTheCastleArray, true, false);
}

bool CGameServerDlg::LoadMonsterStoneListInformationTable()
{
	LOAD_TABLE(CMonsterStoneListInformationSet, g_DBAgent.GetGameDB(), &m_MonsterStoneListInformationArray, true, false);
}

bool CGameServerDlg::LoadJuraidMountionListInformationTable()
{
	LOAD_TABLE(CJuraidMountionListInformationSet, g_DBAgent.GetGameDB(), &m_JuraidMountionListInformationArray, true, false);
}

bool CGameServerDlg::LoadMiningFishingItemTable()
{
	LOAD_TABLE(CMiningFishingTableSet, g_DBAgent.GetGameDB(), &m_MiningFishingItemArray, true, false);
}

bool CGameServerDlg::LoadPremiumItemTable()
{
	LOAD_TABLE(CPremiumItemSet, g_DBAgent.GetGameDB(), &m_PremiumItemArray, true, false);
}

bool CGameServerDlg::LoadPremiumItemExpTable()
{
	LOAD_TABLE(CPremiumItemExpSet, g_DBAgent.GetGameDB(), &m_PremiumItemExpArray, true, false);
}

bool CGameServerDlg::LoadUserDailyOpTable()
{
	LOAD_TABLE(CUserDailyOpSet, g_DBAgent.GetGameDB(), &m_UserDailyOpMap, true, false);
}

bool CGameServerDlg::LoadEventTriggerTable()
{
	LOAD_TABLE(CEventTriggerSet, g_DBAgent.GetGameDB(), &m_EventTriggerArray, true, false);
}

bool CGameServerDlg::LoadStartPositionRandomTable()
{
	LOAD_TABLE(CStartPositionRandomSet, g_DBAgent.GetGameDB(), &m_StartPositionRandomArray, true, false);
}

bool CGameServerDlg::LoadGiftEventArray()
{
	LOAD_TABLE(CGiftEventArray, g_DBAgent.GetGameDB(), &m_RandomItemArray, true, false);
}

bool CGameServerDlg::LoadSendMessageTable()
{
	LOAD_TABLE(CSendMessageSet, g_DBAgent.GetGameDB(), &m_SendMessageArray, true, false);
}

bool CGameServerDlg::LoadRightTopTitleTable()
{
	LOAD_TABLE(CRightTopTitleSet, g_DBAgent.GetGameDB(), &m_RightTopTitleArray, true, false);
}

bool CGameServerDlg::LoadTopLeftTable()
{
	LOAD_TABLE(CTopLeftSet, g_DBAgent.GetGameDB(), &m_TopLeftArray, true, false);
}

bool CGameServerDlg::LoadBanishWinnerTable()
{
	LOAD_TABLE(CBanishWinner, g_DBAgent.GetGameDB(), &m_WarBanishOfWinnerArray, true, false);
}

bool CGameServerDlg::LoadGiveItemExchangeTable()
{
	LOAD_TABLE(CLuaGiveItemExchangeSet, g_DBAgent.GetGameDB(), &m_LuaGiveItemExchangeArray, true, false);
}

bool CGameServerDlg::LoadUserItemTable()
{
	LOAD_TABLE(CUserItemSet, g_DBAgent.GetGameDB(), &m_UserItemArray, true, false);
}
bool CGameServerDlg::LoadPusCategoryTable()
{
	LOAD_TABLE(CPusItemCategory, g_DBAgent.GetGameDB(), &m_PusCategoryArray, true, false);

}
bool CGameServerDlg::LoadSaveBotData()
{
	LOAD_TABLE(CBotSaveDataSet, g_DBAgent.GetGameDB(), &m_BotSaveDataArray, true, false);

}
bool CGameServerDlg::LoadObjectPosTable()
{
	LOAD_TABLE(CObjectPosSet, g_DBAgent.GetGameDB(), &m_ObjectEventArray, true, false);
}
...
bool CGameServerDlg::LoadBotInfoTable(bool only_item)
{
	if (!only_item)
	{
		LOAD_TABLE_ERROR_ONLY(CBotMerchantInfoSet, g_DBAgent.GetGameDB(), &pBotInfo, true, false);
	}
	
	LOAD_TABLE_ERROR_ONLY(CBotMerchantItemSet, g_DBAgent.GetGameDB(), &pBotInfo, true, false);
...
{
	LOAD_TABLE(CPusItemSet, g_DBAgent.GetGameDB(), &m_PusItemArray, false, false);
}

bool CGameServerDlg::LoadTimedNoticeTable() {
	LOAD_TABLE(CTimedNotice, g_DBAgent.GetGameDB(), &m_TimedNoticeArray, true, false);
}

bool CGameServerDlg::LoadRankBugTable() {
	LOAD_TABLE(CRankBugSet, g_DBAgent.GetGameDB(), nullptr, true, false);
}

bool CGameServerDlg::LoadUserLootSettingsTable()
{
	LOAD_TABLE(CUserLootSettingsSet, g_DBAgent.GetGameDB(), &UserLootSettings, false, false);
}

bool CGameServerDlg::LoadServerSettingsData() { 
	LOAD_TABLE(CServerSettingSet, g_DBAgent.GetGameDB(), &pServerSetting, false, false);
}

bool CGameServerDlg::LoadCindirellaItemsTable() {
	LOAD_TABLE_ERROR_ONLY(CCindirellaItemSet1, g_DBAgent.GetGameDB(), &m_CindirellaItemsArray[0], true, false);
	LOAD_TABLE_ERROR_ONLY(CCindirellaItemSet2, g_DBAgent.GetGameDB(), &m_CindirellaItemsArray[1], true, false);
	LOAD_TABLE_ERROR_ONLY(CCindirellaItemSet3, g_DBAgent.GetGameDB(), &m_CindirellaItemsArray[2], true, false);
	LOAD_TABLE_ERROR_ONLY(CCindirellaItemSet4, g_DBAgent.GetGameDB(), &m_CindirellaItemsArray[3], true, false);
	LOAD_TABLE_ERROR_ONLY(CCindirellaItemSet5, g_DBAgent.GetGameDB(), &m_CindirellaItemsArray[4], true, false);
	return true;
}

bool CGameServerDlg::LoadCindirellaSettingTable() {
	LOAD_TABLE(CCindirellaSettingSet, g_DBAgent.GetGameDB(), nullptr, true, false);
}

bool CGameServerDlg::LoadCindirellaRewardsTable() {
	LOAD_TABLE(CCindirellaRewardSet, g_DBAgent.GetGameDB(), nullptr, true, false);
}

bool CGameServerDlg::LoadCindirellaStatSetTable() {
	LOAD_TABLE(CCindirellaStatSet, g_DBAgent.GetGameDB(), &m_CindirellaStatArray, true, false);
}

bool CGameServerDlg::LoadLevelRewardTable() {
	LOAD_TABLE(CLevelRewardsSet, g_DBAgent.GetGameDB(), &m_LevelRewardArray, true, false);
}

bool CGameServerDlg::LoadLevelMerchantRewardTable() {
	LOAD_TABLE(CLevelMerchantRewardsSet, g_DBAgent.GetGameDB(), &m_LevelMerchantRewardArray, true, false);
}

bool CGameServerDlg::LoadJackPotSettingTable() {
	LOAD_TABLE(CJackPotSettingSet, g_DBAgent.GetGameDB(), nullptr, true, false);
}

bool CGameServerDlg::LoadPerksTable() {
	LOAD_TABLE(CPerksSet, g_DBAgent.GetGameDB(), &m_PerksArray, true, false);
}

bool CGameServerDlg::LoadCSWTables() {
	LOAD_TABLE(CCswTimeOptSet, g_DBAgent.GetGameDB(), &pCswEvent.poptions, true, false);
}

bool CGameServerDlg::MapFileLoad()
{
	ZoneInfoMap zoneMap;
	LOAD_TABLE_ERROR_ONLY(CZoneInfoSet, g_DBAgent.GetGameDB(), &zoneMap, false, false);
	...
	LOAD_TABLE_ERROR_ONLY(CEventSet, g_DBAgent.GetGameDB(), &m_ZoneArray, true, false);
	return true;
}
