...
#define GAME_SOURCE_VERSION 1098	// 1098, 1534, 2369
...
#define RELOAD_KNIGHTS_AND_USER_RATING 120 // Minute
...
enum class UserStatusBehaviour
{
	USER_STATUS_CURE	= 0,
...
#define TO_USER(v)	(assert((v) != nullptr), static_cast<CUser *>(v))
#define TO_NPC(v)	(assert((v) != nullptr), static_cast<CNpc *>(v))
