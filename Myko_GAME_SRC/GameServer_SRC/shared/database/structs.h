...
struct	_PARTY_GROUP
{
	...
	/* RECONNECT PARK (Session 25) — Grace period dizileri devre dışı
	int16 graceUid[MAX_PARTY_USERS];
	uint32 graceExpiry[MAX_PARTY_USERS];
	std::string graceName[MAX_PARTY_USERS];
	*/
