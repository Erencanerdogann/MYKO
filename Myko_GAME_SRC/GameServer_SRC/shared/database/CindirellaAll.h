...
public:
	...
	virtual tstring GetTableName() { return _T("MADCLAS_ITEMS0"); }
...
public:
	CCindirellaItemSet2(OdbcConnection* dbConnection, CindirellaItemsArray* pMap)
		: OdbcRecordset(dbConnection), m_pMap(pMap) {}
	virtual tstring GetTableName() { return _T("MADCLAS_ITEMS1"); }
	virtual tstring GetColumns() { return _T("id, class, slotid, itemid, itemcount,itemduration,itemflag,itemexpire"); }
	virtual bool Fetch() {
		int field = 1;
...
public:
	CCindirellaItemSet3(OdbcConnection* dbConnection, CindirellaItemsArray* pMap)
		: OdbcRecordset(dbConnection), m_pMap(pMap) {}
	virtual tstring GetTableName() { return _T("MADCLAS_ITEMS2"); }
	virtual tstring GetColumns() { return _T("id, class, slotid, itemid, itemcount,itemduration,itemflag,itemexpire"); }
	virtual bool Fetch() {
		int field = 1;
...
public:
	CCindirellaItemSet4(OdbcConnection* dbConnection, CindirellaItemsArray* pMap)
		: OdbcRecordset(dbConnection), m_pMap(pMap) {}
	virtual tstring GetTableName() { return _T("MADCLAS_ITEMS3"); }
	virtual tstring GetColumns() { return _T("id, class, slotid, itemid, itemcount,itemduration,itemflag,itemexpire"); }
	virtual bool Fetch() {
		int field = 1;
...
public:
	CCindirellaItemSet5(OdbcConnection* dbConnection, CindirellaItemsArray* pMap)
		: OdbcRecordset(dbConnection), m_pMap(pMap) {}
	virtual tstring GetTableName() { return _T("MADCLAS_ITEMS4"); }
	virtual tstring GetColumns() { return _T("id, class, slotid, itemid, itemcount,itemduration,itemflag,itemexpire"); }
	virtual bool Fetch() {
		int field = 1;
...
public:
	CCindirellaStatSet(OdbcConnection* dbConnection, CindirellaStatArray* pMap)
		: OdbcRecordset(dbConnection), m_pMap(pMap) {}
	virtual tstring GetTableName() { return _T("MADCLAS_STAT"); }
...
public:
	...
	virtual tstring GetTableName() { return _T("MADCLAS_SETTING"); }
...
public:
	...
	virtual tstring GetTableName() { return _T("MADCLAS_REWARD"); }
	virtual tstring GetColumns() {
