...
public:
	...
	virtual tstring GetTableName() { return _T("EVENT_OPEN_DAY"); }
...
public:
	CEventTimeOptSet(OdbcConnection* dbConnection, EVENTMAINTIME* pData)
		: OdbcRecordset(dbConnection), m_pMap(pData) {}
	virtual tstring GetTableName() { return _T("EVENT_OPEN"); }
...
public:
	...
	virtual tstring GetTableName() { return _T("EVENT_ROOM"); }
