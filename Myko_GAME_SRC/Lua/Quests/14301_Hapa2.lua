...
if (EVENT == 240) then
	...
	if(QuestStatus == 1 and ITEM1_COUNT < 1) then
		...
		SelectMsg(UID, 2, -1, 242, NPC, 4018, 4009, 593, 301, 603, 313, 614, 327, 623, 338, 1200, 400, 1284, 450)
end
end
...
if (EVENT == 4025) then
	...
	Class = CheckClass (UID);
	if (Class == 1 or Class == 5 or Class == 6 or Class == 13 or Class == 14 or Class == 15) then
RunRandomExchange(UID,405);
		SaveEvent(UID, 662);
	elseif (Class == 2 or Class == 7 or Class == 8) then
RunRandomExchange(UID,406,STEP,1);
		SaveEvent(UID, 667);
	elseif (Class == 3 or Class == 9 or Class == 10) then
RunRandomExchange(UID,407,STEP,1);
		SaveEvent(UID, 672);
	elseif (Class == 4 or Class == 11 or Class == 12) then
RunRandomExchange(UID,408);
		SaveEvent(UID, 677);
end
end
end
...
RunRandomExchange(UID,56,STEP,1);
	SaveEvent(UID, 362);   
end
end
end
...
if (EVENT == 322) then
	...
	Class = CheckClass (UID);
	if (Class == 1 or Class == 5 or Class == 6 or Class == 13 or Class == 14 or Class == 15) then
RunRandomExchange(UID,60)
		SaveEvent(UID, 384);
	elseif (Class == 2 or Class == 7 or Class == 8) then
RunRandomExchange(UID,61,STEP,1);
		SaveEvent(UID, 389);
	elseif (Class == 3 or Class == 9 or Class == 10) then
RunRandomExchange(UID,62,STEP,1);
		SaveEvent(UID, 394);
	elseif (Class == 4 or Class == 11 or Class == 12) then
RunRandomExchange(UID,63,STEP,1);
		SaveEvent(UID, 399);
end
end
end
...
if EVENT == 343 then 
    ...
    ItemC = HowmuchItem(UID, 900000000); 
      ...
      elseif (ItemC < 5000000) then
       SelectMsg(UID, 2, 192, 629, NPC, 10, -1);
      elseif  (ItemA > 7 and ItemB > 15 and ItemC > 5000000)then
...
if EVENT == 345 then 
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,65)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,66)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,67)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,68)
end
end
end
...
if EVENT == 351 then 
    ...
    ItemC = HowmuchItem(UID, 900000000);  
      ...
      elseif  ItemA > 5 and ItemB > 12 and ItemC > 5000000 then
...
if EVENT == 390 then 
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,69)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,70)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,71)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,72)
end
end
end
...
if EVENT == 357 then 
    ...
    ItemC = HowmuchItem(UID, 900000000);  
      ...
      elseif  ItemA >= 4 and ItemB >= 9 and ItemC >= 5000000 then
...
if EVENT == 358 then
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,73)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,74)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,75)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,76)
end
end
end
...
if EVENT == 364 then 
    ...
    ItemC = HowmuchItem(UID, 900000000);  
      ...
      elseif  ItemA >= 3 and ItemB >= 6 and ItemC >= 5000000 then
...
if EVENT == 365 then 
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,77)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,78)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,79)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,80)
end
end
end
...
if EVENT == 371 then 
    ...
    ItemC = HowmuchItem(UID, 900000000);  
      ...
      elseif  ItemA >= 3 and ItemB >= 3 and ItemC >= 5000000 then
...
if EVENT == 391 then 
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,81)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,82)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,83)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,84)
end
end
end
...
if EVENT == 405 then
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,601)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,602)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,603)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,604)
end
end
end
...
if EVENT == 413 then 
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,605)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,606)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,607)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,608)
end
end
end
...
SlotCheck = CheckGiveSlot(UID, 1)
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,609)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,610)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,611)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,612)
      end
end
end
end
...
if EVENT == 429 then 
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,613)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,614)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,615)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,616)
end
end
end
...
if EVENT == 437 then 
   ...
   Class = CheckClass (UID);
       if Class == 1 or Class == 5 or Class == 6 then
       RunRandomExchange(UID,617)
       elseif Class == 2 or Class == 7 or Class == 8 then
       RunRandomExchange(UID,618)
       elseif Class == 3 or Class == 9 or Class == 10 then
       RunRandomExchange(UID,619)
      elseif Class == 4 or Class == 11 or Class == 12 then
       RunRandomExchange(UID,620)
end
end
end
