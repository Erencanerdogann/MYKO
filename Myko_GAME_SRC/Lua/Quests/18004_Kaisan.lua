...
if (EVENT == 100) then
	SelectMsg(UID, 2, -1, 147, NPC, 4062, 403, 4070, 407, 45424, 699, 45426, 102, 45427, 103)
	-- 10745, 799, 12144, 1010  -- Repurchase ve Rebirth Reset gecici devre disi
end
...
if (EVENT == 102) then
	...
	if (JOBCHANGEITEM > 0) then
		...
		SelectMsg(UID, 2, 73, 147, NPC, 10, 10001);
	end
end
...
if (EVENT == 103) then
	SelectMsg(UID, 2, -1, 147, NPC, 8975, 105, 8976, 991, 10, -1);
end
...
if (EVENT == 991) then
	...
	if (ItemGen >= 1) then
		if (Nation == 1) then
			SelectMsg(UID, 2, -1, 147, NPC, 2002, 250);
		else
			SelectMsg(UID, 2, -1, 147, NPC, 2002, 251);
		end
	else
		ShowMap(UID, 450);
	end
...
if (EVENT == 250) then
	...
	if (WarriorC) then
		SelectMsg(UID, 2, -1, 147, NPC, 10, 101);
	elseif (RogueC) then
		SelectMsg(UID, 2, -1, 147, NPC, 10, 101);
	elseif (MageC) then
		SelectMsg(UID, 2, -1, 147, NPC, 8975, 211, 8976, 212);
	elseif (PriestC) then
		SelectMsg(UID, 2, -1, 147, NPC, 8975, 210, 8976, 212);
	end
end
...
if (EVENT == 251) then
	...
	PriestC = isPriest(UID);
	if (WarriorC) then
		SelectMsg(UID, 2, -1, 147, NPC, 8975, 213, 8976, 214, 10, 215);
	elseif (RogueC) then
		SelectMsg(UID, 2, -1, 147, NPC, 8975, 214, 8976, 215);
	elseif (MageC) then
		SelectMsg(UID, 2, -1, 147, NPC, 8975, 214, 8976, 215);
	elseif (PriestC) then
		SelectMsg(UID, 2, -1, 147, NPC, 8975, 214, 8976, 215);
