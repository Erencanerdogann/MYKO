...
-----------------------------------// 3.Ana Menü	//-----------------------------------
if (EVENT == 102) then  
	SelectMsg(UID, 2, -1, 4131, NPC, 45487, 890, 8975, 1300, 8976, 1310, 4479, 1200, 45528, 1900, 45531, 1910, 45542, 2700, 45216, 2799, 45553, 204, 2003, 101);  
end
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
if (EVENT == 204) then -- CLAN NTS
    CNTS = HowmuchItem(UID, 800400000);      
    if (CNTS < 1 or CNTS == 0) then
        SelectMsg(UID, 2, -1, 4671, NPC, 10, -1);
    else
          ClanNts(UID);  
    end
