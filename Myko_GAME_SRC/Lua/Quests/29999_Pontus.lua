...
-----------------------------------// 1.Ana Menü	//-----------------------------------
if (EVENT == 100) then	 --
	SelectMsg(UID, 2, -1, 4131, NPC, 45434, 660, 45433, 400, 45217, 300, 4504, 631, 45441, 500, 45230, 550, 45231, 570,7055, 720, 45536, 2800,2002,101); 
end
-----------------------------------// 2.Ana Menü	//-----------------------------------
if (EVENT == 101) then  --,45443, 700, 45444, 720, 45446, 780, 45437, 800
	SelectMsg(UID, 2, -1, 4131, NPC, 4344, 760,45486, 860,45487, 890, 8976, 1310, 4479, 1200,45237,556, 45432, 200, 2003, 100);     --100 350 700 1000 2000 5000 10000
end
-----------------------------------// 3.Ana Menü	//-----------------------------------
if (EVENT == 102) then  --, 8975, 1300, 45528, 1900, 45531, 1910
...
if (EVENT == 300) then  ----------- KNIGHT CASH MENU
	SelectMsg(UID, 3, -1, 45238, NPC, 45218, 301, 45219, 302, 45220, 303, 45221, 304, 45223, 305, 45225, 306, 45226, 307, 4296, 100);
end
...
if (EVENT == 304) then  -- 1000 KNIGHT CASH
	...
	if (ITEMA == 0) then
		...
		GiveBalance(UID, 1000, 0);
	end
end
 
if (EVENT == 305) then -- 2000 KNIGHT CASH
	...
	if (ITEMA == 0) then
		...
		GiveBalance(UID, 2000, 0);
	end
end

 if (EVENT == 306) then  -- 5000 KNIGHT CASH
	...
	if (ITEMA == 0) then
		...
		GiveBalance(UID, 5000, 0);
	end
end
 
if (EVENT == 307) then  -- 10000 KNIGHT CASH
...
if (EVENT == 400) then--7803,404,10005,405,8574,406, -- Premium Menu
	SelectMsg(UID, 3, -1, 45238, NPC, 8574, 1950, 7803, 900,  45241, 480, 4296, 100);
end
 
if (EVENT == 1950) then -- Platinum Premium
	SelectMsg(UID, 2, -1, 45276, NPC, 8574, 1951);
end
 
if (EVENT == 1951) then -- Platinum Premium ( 30 Days )
...
if (EVENT == 440) then -- Silver Premium
	SelectMsg(UID, 2, -1, 9954, NPC, 4296, 400);
end
 
if (EVENT == 441) then -- Silver Premium ( 30 Day )
	EXPPREM = HowmuchItem(UID, 810936742);
	if (EXPPREM < 1 or EXPPREM == 0) then
...
SlotCheck = CheckGiveSlot(UID, 21)
     if SlotCheck == false then
    else   
   	RobItem(UID, 810035000, 1);
	GiveItem(UID, 800880754, 1); -- Platinum Premium
	GiveItem(UID, 700191000, 1); -- Genie + Auto Loot
	GiveItem(UID, 508057000, 1); -- Valkyrie Armor
	GiveItem(UID, 508056000, 1); -- Valkyrie Helmet
	...
	GiveItem(UID, 800078000, 1); -- 2000 Buf Scroll
	GiveItem(UID, 800076000, 1); -- 350 Ac Scroll
	GiveItem(UID, 800014000, 1); -- Attack Scroll  800250000
	GiveItem(UID, 800250000, 1); -- Pathos 
	GiveItem(UID, 800250000, 1); -- Pathos 
	end
end
end
...
if (EVENT == 2716) then
	...
	PerksPoint(UID, 0, 1, 0)
	end
end
 
----------------------------------------------------------------------------------------------------------------------------------------------------------
 
if (EVENT == 2800) then -- Tattoo Exchange Menu
	SelectMsg(UID, 3, -1, 4131, NPC, 45537, 2801, 45538, 2803, 45539, 2805, 45540, 2807, 4296, 100);
end
 
if (EVENT == 2801) then -- Solar Tattoo Exchange
	TATTOO = HowmuchItem(UID, 810926000);
	if (TATTOO < 1 or TATTOO == 0) then
		SelectMsg(UID, 2, -1, 45276, NPC, 18, 5000);
	else
		EVENT = 2802
	end
...
if (EVENT == 2803) then -- Lunar Tattoo Exchange
	TATTOO = HowmuchItem(UID, 810927000);
	if (TATTOO < 1 or TATTOO == 0) then
		SelectMsg(UID, 2, -1, 45276, NPC, 18, 5000);
	else
		EVENT = 2804
...
if (EVENT == 2805) then -- Stella Tattoo Exchange
	TATTOO = HowmuchItem(UID, 810928000);
	if (TATTOO < 1 or TATTOO == 0) then
		SelectMsg(UID, 2, -1, 45276, NPC, 18, 5000);
	else
		EVENT = 2806
...
if (EVENT == 2807) then -- Nimbus Tattoo Exchange
	TATTOO = HowmuchItem(UID, 810929000);
	if (TATTOO < 1 or TATTOO == 0) then
		SelectMsg(UID, 2, -1, 45276, NPC, 18, 5000);
	else
		EVENT = 2808
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
 if (EVENT == 420) then -- Minerva Pack
	MINEVRAPACK = HowmuchItem(UID, 508156000);
...
if (EVENT == 421) then
	MINEVRAPACK = HowmuchItem(UID, 508157000);
	if (MINEVRAPACK < 1 or MINEVRAPACK == 0) then
		SelectMsg(UID, 2, -1, 9622, NPC, 18, 5000);
	else
...
if (EVENT == 556) then -- Wing Of Dragon
	SelectMsg(UID, 3, -1, 3018, NPC,45238,552,45239,35264, 40536,111,8611,118,9017,138,4296, 100);
end
----------------------------------------------------------------------------------------
...
if (EVENT == 720) then --, 4285, 721, 4286, 722, 4287, 723, 4420, 724, 4421, 725, 4589, 726, 4588, 727,
	SelectMsg(UID, 3, -1, 4914, NPC, 7065, 728, 7064, 729, 27, -1);
end
