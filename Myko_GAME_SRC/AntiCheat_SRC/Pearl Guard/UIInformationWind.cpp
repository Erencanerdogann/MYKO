...
void UIMerchantWindTick()
{
	while (true)
	{
		if (Engine != NULL && Engine->m_bGameStart && Engine->uiInformationWind != NULL && Engine->uiInformationWind->merchant_state)
...
void UINoticeWindTick()
{
	while (true)
	{
		if (Engine != NULL && Engine->m_bGameStart && Engine->uiInformationWind != NULL && Engine->uiInformationWind->notice_state)
