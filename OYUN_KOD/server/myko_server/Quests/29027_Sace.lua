...
if (EVENT == 1508)then
	-- MonsterStoneQuestJoin(UID,702);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 1908)then
	-- MonsterStoneQuestJoin(UID,708);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 2308)then
	-- MonsterStoneQuestJoin(UID,714);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 2708)then
	-- MonsterStoneQuestJoin(UID,720);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 3008)then
	-- MonsterStoneQuestJoin(UID,726);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 3508)then
	-- MonsterStoneQuestJoin(UID,732);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 3908)then
	-- MonsterStoneQuestJoin(UID,738);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 4309)then
	-- MonsterStoneQuestJoin(UID,744);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 4709)then
	-- MonsterStoneQuestJoin(UID,750);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 5109)then
	-- MonsterStoneQuestJoin(UID,756);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 5509)then
	-- MonsterStoneQuestJoin(UID,762);  -- KOD-4: C++ binding yok
end
...
if (EVENT == 5909)then
	-- MonsterStoneQuestJoin(UID,768);  -- KOD-4: C++ binding yok
end
