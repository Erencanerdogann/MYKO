...
if (EVENT == 100) then	
	SelectMsg(UID, 2, -1, 845, NPC, 4522, 106, 45536, 500); 
end
...
if (EVENT == 500) then	-- [Exchange] National Points ( NP )
	SelectMsg(UID, 2, -1, 845, NPC, 45537, 501, 45538, 503, 45539, 505); 
end

if (EVENT == 501) then -- Exchange [10.000 NP]
	NATION = CheckLoyalty(UID)
	if (NATION < 10000 or NATION == 0) then
		SelectMsg(UID, 2, -1, 45277, NPC, 18, 5000);
	else
    EVENT = 502
	end
end
...
if (EVENT == 503) then -- Exchange [20.000 NP]
	NATION = CheckLoyalty(UID)
	if (NATION < 20000 or NATION == 0) then
		SelectMsg(UID, 2, -1, 45278, NPC, 18, 5000);
	else
    EVENT = 504
	end
end
...
if (EVENT == 505) then -- Exchange [30.000 NP]
	NATION = CheckLoyalty(UID)
	if (NATION < 30000 or NATION == 0) then
		SelectMsg(UID, 2, -1, 45272, NPC, 13, 5000);
	else
    EVENT = 506
	end
end
...
if (EVENT == 506) then
	...
	Check = CheckExchange(UID, 12272) --Bu alan ile 
			if  Check == true then   
				Roll = RollDice(UID, 20) 
				found = Roll + 12260 -- Bu alan arası itemler var exchange tablosunda
				RunRandomExchange(UID, found);
	end
end
end
