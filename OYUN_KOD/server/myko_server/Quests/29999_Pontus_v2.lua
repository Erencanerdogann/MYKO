...
-----------------------------------// 1.Ana Menü	//-----------------------------------
if (EVENT == 100) then	
	SelectMsg(UID, 2, -1, 4131, NPC,40386,500,45432, 200,45442, 680,8975, 1300, 4479, 1200); 
end
...
if (EVENT == 300) then  ----------- KNIGHT CASH MENU
	SelectMsg(UID, 3, -1, 45238, NPC, 45218, 301, 45219, 302, 45220, 303, 45222, 304, 45224, 305, 4296, 100);
end
...
if (EVENT == 400) then--7803,404,10005,405,8574,406, -- Premium Menu
	SelectMsg(UID, 3, -1, 45238, NPC, 7197, 401, 7198, 420, 7252, 440, 8635, 460, 45241, 480, 4296, 100);
end
