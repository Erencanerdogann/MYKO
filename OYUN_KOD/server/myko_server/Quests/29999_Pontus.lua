...
-----------------------------------// 1.Ana Menü	//-----------------------------------
if (EVENT == 100) then	
	SelectMsg(UID, 2, -1, 4131, NPC, 45434, 660, 45433, 400, 45217, 300, 45432, 200, 45230, 550, 45441, 500, 45231, 570, 45435, 600, 2002, 101); 
end
-----------------------------------// 2.Ana Menü	//-----------------------------------
if (EVENT == 101) then  
	SelectMsg(UID, 2, -1, 4131, NPC,45443, 700, 45444, 720, 4344, 760, 45448, 820, 45451, 840, 45486, 860, 4479, 1200, 45216, 2799, 2002, 102);   
end
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
if (EVENT == 400) then
	SelectMsg(UID, 3, -1, 45238, NPC, 8574, 1950, 7803, 900, 10005, 2750, 45241, 480, 4296, 100);
end
----------------------------------------------------------------------------------------------------------------------------------------------------------
...
if (EVENT == 480) then -- Clan Premium
    ...
    if (CLANPREM < 1) then
		...
		GiveItem(UID, 700002000, 1); -- Trina 
		GiveItem(UID, 750680000, 1); -- Auto loot
...
if (EVENT == 600) then
	SelectMsg(UID, 3, -1, 4901, NPC, 4286, 602, 4287, 1150, 4420, 611, 4421, 616, 4589, 621, 4588, 626, 4504, 631, 4296, 100);
end
...
if (EVENT == 860) then -- Job Change Menü
	SelectMsg(UID, 3, -1, 4131, NPC, 45426, 870, 4296, 100);
end
...
if (EVENT == 1935) then -- Exchange [ New EXP Jar ]
	EXPPREM = HowmuchItem(UID, 810357000);
	if (EXPPREM < 1 or EXPPREM == 0) then
...
if (EVENT == 2710) then -- [Exchange] EXP Jar + Silver Bar ( 1 Point )
	EXPPREM = HowmuchItem(UID, 810357000);
	EXPPREM = HowmuchItem(UID, 379067000);
